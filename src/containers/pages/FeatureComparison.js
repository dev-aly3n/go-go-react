            ...
            <Fragment>
                    ...
                    <Card className="mb-3 table-heading">
                        <div className="d-flex flex-grow-1 min-width-zero">
                            <CardBody className="align-self-center d-flex flex-column flex-md-row justify-content-between min-width-zero align-items-md-center">
                                ...
                                <p className="mb-0 text-primary w-20 w-xs-100 text-center"><IntlMessages id="pages.price.developer" /></p>
                                <p className="mb-0 text-primary w-20 w-xs-100 text-center"><IntlMessages id="pages.price.team" /></p>
                                <p className="mb-0 text-primary w-20 w-xs-100 text-center"><IntlMessages id="pages.price.enterprise" /></p>
                            </CardBody>
                        </div>
                    </Card>
                ...
                <Colxx xxs="12" className="d-block d-md-none">
                    <Card className="d-flex flex-row mb-3 table-heading">
                        <div className="d-flex flex-grow-1 min-width-zero">
                            <CardBody className="pl-0 pb-0">
                                <p className="list-item-heading mb-0 text-primary"><IntlMessages id="pages.price.twofactorauthentication" /></p>
                            </CardBody>
                        </div>
                    </Card>
                    ...
                    <Card className="d-flex flex-row mb-3 table-heading">
                        <div className="d-flex flex-grow-1 min-width-zero">
                            <CardBody className="pl-0 pb-0">
                                <p className="list-item-heading mb-0 text-primary"><IntlMessages id="pages.price.teampermissions" /></p>
                            </CardBody>
                        </div>
                    </Card>
                    <Card className="d-flex flex-row mb-3">
                    ...
                    <Card className="d-flex flex-row mb-3 table-heading">
                        <div className="d-flex flex-grow-1 min-width-zero">
                            <CardBody className="pl-0 pb-0">
                                <p className="list-item-heading mb-0 text-primary"><IntlMessages id="pages.price.245Support" /></p>
                            </CardBody>
                        </div>
                    </Card>
                    <Card className="d-flex flex-row mb-3">
                    ...
                    <Card className="d-flex flex-row mb-3 table-heading">
                        <div className="d-flex flex-grow-1 min-width-zero">
                            <CardBody className="pl-0 pb-0">
                                <p className="list-item-heading mb-0 text-primary"><IntlMessages id="pages.price.247Support" /></p>
                            </CardBody>
                        </div>
                    </Card>
                    <Card className="d-flex flex-row mb-3">
                    ...
                    <Card className="d-flex flex-row mb-3 table-heading">
                        <div className="d-flex flex-grow-1 min-width-zero">
                            <CardBody className="pl-0 pb-0">
                                <p className="list-item-heading mb-0 text-primary"><IntlMessages id="pages.price.useractionsauditlog" /></p>
                            </CardBody>
                        </div>
                    </Card>
                    <Card className="d-flex flex-row mb-3">
